...
<template>
    <v-bottom-navigation v-model="selectedTab" mode="shift" grow mandatory :color="primaryColor" @update:model-value="onTabChange">
        <v-btn v-for="tab in tabs" :key="tab.key" :value="pathToIndex[tab.path]">
